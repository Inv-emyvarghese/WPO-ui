import { FileText, LogOut, ShieldCheck, User, Users } from "lucide-react";
  ...
  const sidebarItemsTop = [
    {
      ...
      icon: <Users className="size-6 shrink-0" aria-hidden />,
      path: "/",
    },
    {
      itemName: t("sidebar.user"),
      icon: <User className="size-6 shrink-0" aria-hidden />,
  ...
  const sidebarItemsBottom = [
    {
      ...
      icon: <FileText className="size-6 shrink-0" aria-hidden />,
      path: "/terms-of-service",
    },
    {
      itemName: t("sidebar.privacy"),
      icon: <ShieldCheck className="size-6 shrink-0" aria-hidden />,
      path: "/privacy-policy",
    },
  ];
